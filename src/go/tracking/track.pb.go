...
func (*Track) Descriptor() ([]byte, []int) {
	return fileDescriptor_track_fa41199ce7f1e9d6, []int{0}
}
...
func (*Track_Flags) Descriptor() ([]byte, []int) {
	return fileDescriptor_track_fa41199ce7f1e9d6, []int{0, 0}
}
...
func (dst *Track_Flags) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Track_Flags.Merge(dst, src)
}
...
func (*Track_Batch) Descriptor() ([]byte, []int) {
	return fileDescriptor_track_fa41199ce7f1e9d6, []int{0, 1}
}
...
func (dst *Track_Batch) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Track_Batch.Merge(dst, src)
}
...
func init() { proto.RegisterFile("tracking/track.proto", fileDescriptor_track_fa41199ce7f1e9d6) }

var fileDescriptor_track_fa41199ce7f1e9d6 = []byte{
