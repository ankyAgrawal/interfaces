...
func (*Track) Descriptor() ([]byte, []int) {
	return fileDescriptor_track_8a519ca1c9895d8b, []int{0}
}
...
func (*Track_Batch) Descriptor() ([]byte, []int) {
	return fileDescriptor_track_8a519ca1c9895d8b, []int{0, 0}
}
...
func init() { proto.RegisterFile("tracking/track.proto", fileDescriptor_track_8a519ca1c9895d8b) }

var fileDescriptor_track_8a519ca1c9895d8b = []byte{
