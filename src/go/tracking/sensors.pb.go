...
func (*Sensor) Descriptor() ([]byte, []int) {
	return fileDescriptor_sensors_4d2ad7c8a4285c7d, []int{0}
}
...
func (*Sensor) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Sensor_OneofMarshaler, _Sensor_OneofUnmarshaler, _Sensor_OneofSizer, []interface{}{
		(*Sensor_Fused_)(nil),
...
func _Sensor_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Sensor)
	// details
	switch x := m.Details.(type) {
	case *Sensor_Fused_:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Fused); err != nil {
			return err
		}
	case *Sensor_PrimaryRadar_:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.PrimaryRadar); err != nil {
			return err
		}
	case *Sensor_SecondaryRadar_:
		b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.SecondaryRadar); err != nil {
			return err
		}
	case *Sensor_Adsb_:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Adsb); err != nil {
			return err
		}
	case *Sensor_Gnss_:
		b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Gnss); err != nil {
			return err
		}
	case *Sensor_RadioFrequency_:
		b.EncodeVarint(6<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RadioFrequency); err != nil {
			return err
		}
	case *Sensor_ElectroOptical_:
		b.EncodeVarint(7<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ElectroOptical); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("Sensor.Details has unexpected type %T", x)
	}
	return nil
}

func _Sensor_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Sensor)
	switch tag {
	case 1: // details.fused
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Sensor_Fused)
		err := b.DecodeMessage(msg)
		m.Details = &Sensor_Fused_{msg}
		return true, err
	case 2: // details.primary_radar
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Sensor_PrimaryRadar)
		err := b.DecodeMessage(msg)
		m.Details = &Sensor_PrimaryRadar_{msg}
		return true, err
	case 3: // details.secondary_radar
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Sensor_SecondaryRadar)
		err := b.DecodeMessage(msg)
		m.Details = &Sensor_SecondaryRadar_{msg}
		return true, err
	case 4: // details.adsb
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
	...
	case 5: // details.gnss
		...
		msg := new(Sensor_Gnss)
		err := b.DecodeMessage(msg)
		m.Details = &Sensor_Gnss_{msg}
		return true, err
	case 6: // details.radio_frequency
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Sensor_RadioFrequency)
		err := b.DecodeMessage(msg)
		m.Details = &Sensor_RadioFrequency_{msg}
		return true, err
	case 7: // details.electro_optical
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Sensor_ElectroOptical)
		err := b.DecodeMessage(msg)
		m.Details = &Sensor_ElectroOptical_{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Sensor_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*Sensor)
	// details
	switch x := m.Details.(type) {
	case *Sensor_Fused_:
		s := proto.Size(x.Fused)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Sensor_PrimaryRadar_:
		s := proto.Size(x.PrimaryRadar)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Sensor_SecondaryRadar_:
		s := proto.Size(x.SecondaryRadar)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Sensor_Adsb_:
	...
	case *Sensor_Gnss_:
		...
		n += s
	case *Sensor_RadioFrequency_:
		s := proto.Size(x.RadioFrequency)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Sensor_ElectroOptical_:
		s := proto.Size(x.ElectroOptical)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*Sensor_Fused) Descriptor() ([]byte, []int) {
	return fileDescriptor_sensors_4d2ad7c8a4285c7d, []int{0, 0}
}
...
func (dst *Sensor_Fused) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Sensor_Fused.Merge(dst, src)
}
...
func (*Sensor_PrimaryRadar) Descriptor() ([]byte, []int) {
	return fileDescriptor_sensors_4d2ad7c8a4285c7d, []int{0, 1}
}
...
func (dst *Sensor_PrimaryRadar) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Sensor_PrimaryRadar.Merge(dst, src)
}
...
func (*Sensor_SecondaryRadar) Descriptor() ([]byte, []int) {
	return fileDescriptor_sensors_4d2ad7c8a4285c7d, []int{0, 2}
}
...
func (dst *Sensor_SecondaryRadar) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Sensor_SecondaryRadar.Merge(dst, src)
}
...
func (*Sensor_Adsb) Descriptor() ([]byte, []int) {
	return fileDescriptor_sensors_4d2ad7c8a4285c7d, []int{0, 3}
}
...
func (dst *Sensor_Adsb) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Sensor_Adsb.Merge(dst, src)
}
...
func (*Sensor_RadioFrequency) Descriptor() ([]byte, []int) {
	return fileDescriptor_sensors_4d2ad7c8a4285c7d, []int{0, 4}
}
...
func (dst *Sensor_RadioFrequency) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Sensor_RadioFrequency.Merge(dst, src)
}
...
func (*Sensor_Gnss) Descriptor() ([]byte, []int) {
	return fileDescriptor_sensors_4d2ad7c8a4285c7d, []int{0, 5}
}
...
func (dst *Sensor_Gnss) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Sensor_Gnss.Merge(dst, src)
}
...
func (*Sensor_ElectroOptical) Descriptor() ([]byte, []int) {
	return fileDescriptor_sensors_4d2ad7c8a4285c7d, []int{0, 6}
}
...
func (dst *Sensor_ElectroOptical) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Sensor_ElectroOptical.Merge(dst, src)
}
...
func init() { proto.RegisterFile("tracking/sensors.proto", fileDescriptor_sensors_4d2ad7c8a4285c7d) }

var fileDescriptor_sensors_4d2ad7c8a4285c7d = []byte{
