...
func (*ConnectProviderParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_21e8fb0491fb5835, []int{0}
}
...
func (dst *ConnectProviderParameters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConnectProviderParameters.Merge(dst, src)
}
...
func (*ConnectProcessorParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_21e8fb0491fb5835, []int{1}
}
...
func (*Update) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_21e8fb0491fb5835, []int{2}
}
...
func (*Update_FromProvider) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_21e8fb0491fb5835, []int{2, 0}
}
...
func _Update_FromProvider_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Update_FromProvider_Params:
...
func _Update_FromProvider_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 3: // details.params
		...
		msg := new(ConnectProviderParameters)
		err := b.DecodeMessage(msg)
		m.Details = &Update_FromProvider_Params{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*Update_ToProvider) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_21e8fb0491fb5835, []int{2, 1}
}
...
func (*Update_ToProcessor) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_21e8fb0491fb5835, []int{2, 2}
}
...
func (*Update_FromProcessor) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_21e8fb0491fb5835, []int{2, 3}
}
...
func init() { proto.RegisterFile("tracking/collector.proto", fileDescriptor_collector_21e8fb0491fb5835) }

var fileDescriptor_collector_21e8fb0491fb5835 = []byte{
