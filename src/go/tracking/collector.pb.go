...
func (*Update) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_fd547542c3b5dfc8, []int{0}
}
...
func (*Update_FromProvider) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_fd547542c3b5dfc8, []int{0, 0}
}
...
type Update_FromProvider_Monitor struct {
	Monitor *system.Monitor `protobuf:"bytes,3,opt,name=monitor,proto3,oneof"`
}
...
func (*Update_FromProvider_Monitor) isUpdate_FromProvider_Details() {}
...
func (m *Update_FromProvider) GetMonitor() *system.Monitor {
	if x, ok := m.GetDetails().(*Update_FromProvider_Monitor); ok {
		return x.Monitor
	}
	return nil
}
...
func (*Update_FromProvider) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Update_FromProvider_OneofMarshaler, _Update_FromProvider_OneofUnmarshaler, _Update_FromProvider_OneofSizer, []interface{}{
		...
		(*Update_FromProvider_Monitor)(nil),
	}
}
...
func _Update_FromProvider_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Update_FromProvider_Monitor:
...
func _Update_FromProvider_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 2: // details.batch
		...
		return true, err
	case 3: // details.monitor
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(system.Monitor)
		err := b.DecodeMessage(msg)
		m.Details = &Update_FromProvider_Monitor{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*Update_ToProvider) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_fd547542c3b5dfc8, []int{0, 1}
}
...
func (*Update_ToProcessor) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_fd547542c3b5dfc8, []int{0, 2}
}
...
func (*Update_FromProcessor) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_fd547542c3b5dfc8, []int{0, 3}
}
...
type Update_FromProcessor_Monitor struct {
	Monitor *system.Monitor `protobuf:"bytes,3,opt,name=monitor,proto3,oneof"`
}
...
func (*Update_FromProcessor_Monitor) isUpdate_FromProcessor_Details() {}
...
func (m *Update_FromProcessor) GetMonitor() *system.Monitor {
	if x, ok := m.GetDetails().(*Update_FromProcessor_Monitor); ok {
		return x.Monitor
	}
	return nil
}
...
func (*Update_FromProcessor) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Update_FromProcessor_OneofMarshaler, _Update_FromProcessor_OneofUnmarshaler, _Update_FromProcessor_OneofSizer, []interface{}{
		...
		(*Update_FromProcessor_Monitor)(nil),
	}
}
...
func _Update_FromProcessor_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Update_FromProcessor_Monitor:
		b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Monitor); err != nil {
			return err
		}
...
func _Update_FromProcessor_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 3: // details.monitor
		...
		msg := new(system.Monitor)
		err := b.DecodeMessage(msg)
		m.Details = &Update_FromProcessor_Monitor{msg}
		return true, err
	default:
		return false, nil
	}
...
func init() { proto.RegisterFile("tracking/collector.proto", fileDescriptor_collector_fd547542c3b5dfc8) }

var fileDescriptor_collector_fd547542c3b5dfc8 = []byte{
	// 379 bytes of a gzipped FileDescriptorProto
	,
}
