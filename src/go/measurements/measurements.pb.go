...
package measurements // import "github.com/airmap/interfaces/src/go/measurements"
...
func (Altitude_Reference) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{2, 0}
}
...
func (*Position) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{0}
}
...
func (*Position) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Position_OneofMarshaler, _Position_OneofUnmarshaler, _Position_OneofSizer, []interface{}{
		(*Position_Absolute_)(nil),
		(*Position_Relative_)(nil),
	}
}

func _Position_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Position)
	// details
	switch x := m.Details.(type) {
	case *Position_Absolute_:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Absolute); err != nil {
			return err
		}
	case *Position_Relative_:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Relative); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("Position.Details has unexpected type %T", x)
	}
	return nil
}

func _Position_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Position)
	switch tag {
	case 1: // details.absolute
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Position_Absolute)
		err := b.DecodeMessage(msg)
		m.Details = &Position_Absolute_{msg}
		return true, err
	case 2: // details.relative
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Position_Relative)
		err := b.DecodeMessage(msg)
		m.Details = &Position_Relative_{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Position_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*Position)
	// details
	switch x := m.Details.(type) {
	case *Position_Absolute_:
		s := proto.Size(x.Absolute)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Position_Relative_:
		s := proto.Size(x.Relative)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*Position_Absolute) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{0, 0}
}
...
func (dst *Position_Absolute) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Position_Absolute.Merge(dst, src)
}
...
func (*Position_Relative) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{0, 1}
}
...
func (dst *Position_Relative) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Position_Relative.Merge(dst, src)
}
...
func (*Position_Relative_Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{0, 1, 0}
}
...
func (dst *Position_Relative_Error) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Position_Relative_Error.Merge(dst, src)
}
...
func (*Coordinate2D) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{1}
}
...
func (*Coordinate2D_Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{1, 0}
}
...
func (*Altitude) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{2}
}
...
func (dst *Altitude) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Altitude.Merge(dst, src)
}
...
func (dst *Altitude_Error) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Altitude_Error.Merge(dst, src)
}
...
func (*Velocity) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{3}
}
...
func (dst *Velocity) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Velocity.Merge(dst, src)
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*Velocity) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Velocity_OneofMarshaler, _Velocity_OneofUnmarshaler, _Velocity_OneofSizer, []interface{}{
		(*Velocity_Polar_)(nil),
		(*Velocity_Cartesian_)(nil),
	}
}

func _Velocity_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Velocity)
	// details
	switch x := m.Details.(type) {
	case *Velocity_Polar_:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Polar); err != nil {
			return err
		}
	case *Velocity_Cartesian_:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Cartesian); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("Velocity.Details has unexpected type %T", x)
	}
	return nil
}

func _Velocity_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Velocity)
	switch tag {
	case 1: // details.polar
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Velocity_Polar)
		err := b.DecodeMessage(msg)
		m.Details = &Velocity_Polar_{msg}
		return true, err
	case 2: // details.cartesian
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Velocity_Cartesian)
		err := b.DecodeMessage(msg)
		m.Details = &Velocity_Cartesian_{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Velocity_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*Velocity)
	// details
	switch x := m.Details.(type) {
	case *Velocity_Polar_:
		s := proto.Size(x.Polar)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Velocity_Cartesian_:
		s := proto.Size(x.Cartesian)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*Velocity_Polar) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{3, 0}
}
...
func (dst *Velocity_Polar) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Velocity_Polar.Merge(dst, src)
}
...
func (*Velocity_Polar_Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{3, 0, 0}
}
...
func (dst *Velocity_Polar_Error) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Velocity_Polar_Error.Merge(dst, src)
}
...
func (*Velocity_Cartesian) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{3, 1}
}
...
func (dst *Velocity_Cartesian) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Velocity_Cartesian.Merge(dst, src)
}
...
func (*Velocity_Cartesian_Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{3, 1, 0}
}
...
func (dst *Velocity_Cartesian_Error) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Velocity_Cartesian_Error.Merge(dst, src)
}
...
func (*Orientation) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{4}
}
...
func (*Orientation_Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{4, 0}
}
...
func (dst *Orientation_Error) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Orientation_Error.Merge(dst, src)
}
...
func (*Pressure) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{5}
}
...
func (dst *Pressure) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Pressure.Merge(dst, src)
}
...
func (*Pressure_Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{5, 0}
}
...
func (dst *Pressure_Error) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Pressure_Error.Merge(dst, src)
}
...
func (*Temperature) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{6}
}
...
func (*Temperature_Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{6, 0}
}
...
func (dst *Temperature_Error) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Temperature_Error.Merge(dst, src)
}
...
func (*Wind) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{7}
}
...
func (*Wind_Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_measurements_d866e58cfa77d274, []int{7, 0}
}
...
func (dst *Wind_Error) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Wind_Error.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("measurements/measurements.proto", fileDescriptor_measurements_d866e58cfa77d274)
}

var fileDescriptor_measurements_d866e58cfa77d274 = []byte{
