...
var E_DefaultDegrees = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60002,opt,name=default_degrees,json=defaultDegrees",
...
var E_MinDegrees = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60003,opt,name=min_degrees,json=minDegrees",
	Filename:      "units/extensions.proto",
}
...
var E_MaxDegrees = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60004,opt,name=max_degrees,json=maxDegrees",
	Filename:      "units/extensions.proto",
}
...
var E_DefaultMeters = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60005,opt,name=default_meters,json=defaultMeters",
	Filename:      "units/extensions.proto",
}
...
var E_MinMeters = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60006,opt,name=min_meters,json=minMeters",
	Filename:      "units/extensions.proto",
}
...
var E_MaxMeters = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60007,opt,name=max_meters,json=maxMeters",
	Filename:      "units/extensions.proto",
}
...
var E_DefaultMetersPerSecond = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60008,opt,name=default_meters_per_second,json=defaultMetersPerSecond",
	Filename:      "units/extensions.proto",
}
...
var E_MinMetersPerSecond = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60009,opt,name=min_meters_per_second,json=minMetersPerSecond",
	Filename:      "units/extensions.proto",
}
...
var E_MaxMetersPerSecond = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60010,opt,name=max_meters_per_second,json=maxMetersPerSecond",
	Filename:      "units/extensions.proto",
}
...
var E_DefaultPascals = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60011,opt,name=default_pascals,json=defaultPascals",
	Filename:      "units/extensions.proto",
}
...
var E_MinPascals = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60012,opt,name=min_pascals,json=minPascals",
	Filename:      "units/extensions.proto",
}
...
var E_MaxPascals = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60013,opt,name=max_pascals,json=maxPascals",
	Filename:      "units/extensions.proto",
}
...
var E_DefaultCelsius = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60014,opt,name=default_celsius,json=defaultCelsius",
	Filename:      "units/extensions.proto",
}
...
var E_MinCelsius = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60015,opt,name=min_celsius,json=minCelsius",
	Filename:      "units/extensions.proto",
}
...
var E_MaxCelsius = &proto.ExtensionDesc{
	...
	Tag:           "bytes,60016,opt,name=max_celsius,json=maxCelsius",
	Filename:      "units/extensions.proto",
}
...
func init() { proto.RegisterFile("units/extensions.proto", fileDescriptor_extensions_a418468cf0655161) }

var fileDescriptor_extensions_a418468cf0655161 = []byte{
