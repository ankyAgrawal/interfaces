...
func (*OperationQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_archive_be0fbe4ac6561aa1, []int{0}
}
...
func (dst *OperationQuery) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OperationQuery.Merge(dst, src)
}
...
func init() { proto.RegisterFile("telemetry/archive.proto", fileDescriptor_archive_be0fbe4ac6561aa1) }

var fileDescriptor_archive_be0fbe4ac6561aa1 = []byte{
