...
func (*Update) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_570305fab1ca1f55, []int{0}
}
...
func (*Update_FromProvider) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_570305fab1ca1f55, []int{0, 0}
}
...
func (*Update_ToProvider) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_570305fab1ca1f55, []int{0, 1}
}
...
func init() {
	proto.RegisterFile("telemetry/collector.proto", fileDescriptor_collector_570305fab1ca1f55)
}

var fileDescriptor_collector_570305fab1ca1f55 = []byte{
