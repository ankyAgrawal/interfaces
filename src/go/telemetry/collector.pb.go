...
func (*Update) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_bd29279504cdd000, []int{0}
}
...
func (*Update_FromProvider) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_bd29279504cdd000, []int{0, 0}
}
...
func _Update_FromProvider_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Update_FromProvider_Report:
...
func _Update_FromProvider_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // details.status
		...
		return true, err
	case 2: // details.report
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Report)
		err := b.DecodeMessage(msg)
		m.Details = &Update_FromProvider_Report{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*Update_ToProvider) Descriptor() ([]byte, []int) {
	return fileDescriptor_collector_bd29279504cdd000, []int{0, 1}
}
...
func init() {
	proto.RegisterFile("telemetry/collector.proto", fileDescriptor_collector_bd29279504cdd000)
}

var fileDescriptor_collector_bd29279504cdd000 = []byte{
